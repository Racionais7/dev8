    ...
    >
      ...
      <div 
        ...
        style={{
          ...
          boxShadow: isHovered 
            ? '0 20px 40px -12px rgba(0,0,0,0.5), inset 0 1px 0 rgba(255,255,255,0.08), 0 0 0 1px rgba(255,255,255,0.05)' 
            : '0 8px 24px -8px rgba(0,0,0,0.4), inset 0 1px 0 rgba(255,255,255,0.04), 0 0 0 1px rgba(255,255,255,0.02)'
        }}
      >
        {/* ARTWORK AREA */}
        <div 
